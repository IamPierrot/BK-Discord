import { Client, ClientOptions, Collection, GatewayIntentBits, Invite, Partials } from "discord.js";
...
export class LoliBotClient extends Client {
     ...
     savedInvites: Collection<string, Collection<string, Invite>> = new Collection();
     savedVanityUses: Collection<string, number> = new Collection();

     readonly gemini = new GoogleGenerativeAI(configure.GEMINI).getGenerativeModel({ model: "gemini-pro" })

     readonly localGuild = "1276794830382432317";
